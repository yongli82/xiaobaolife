...
public class CategoryResourceIntTest {
    ...
    public static Category createEntity(EntityManager em) {
        ...
        category.setCode(DEFAULT_CODE);
        category.setName(DEFAULT_NAME);
        category.setDescription(DEFAULT_DESCRIPTION);
        category.setCoverImageBig(DEFAULT_COVER_IMAGE_BIG);
        category.setCoverImageSmall(DEFAULT_COVER_IMAGE_SMALL);
        category.setMemo(DEFAULT_MEMO);
        category.setRecordStatus(DEFAULT_RECORD_STATUS);
        return category;
    }
    ...
    public void createCategory() throws Exception {
        ...
        assertThat(testCategory.getCoverImageBig()).isEqualTo(DEFAULT_COVER_IMAGE_BIG);
        assertThat(testCategory.getCoverImageSmall()).isEqualTo(DEFAULT_COVER_IMAGE_SMALL);
        assertThat(testCategory.getMemo()).isEqualTo(DEFAULT_MEMO);
        assertThat(testCategory.getRecordStatus()).isEqualTo(DEFAULT_RECORD_STATUS);
    }
    ...
    public void updateCategory() throws Exception {
        ...
        updatedCategory.setCode(UPDATED_CODE);
        updatedCategory.setName(UPDATED_NAME);
        updatedCategory.setDescription(UPDATED_DESCRIPTION);
        updatedCategory.setCoverImageBig(UPDATED_COVER_IMAGE_BIG);
        updatedCategory.setCoverImageSmall(UPDATED_COVER_IMAGE_SMALL);
        updatedCategory.setMemo(UPDATED_MEMO);
        updatedCategory.setRecordStatus(UPDATED_RECORD_STATUS);
        ...
        assertThat(testCategory.getCoverImageBig()).isEqualTo(UPDATED_COVER_IMAGE_BIG);
        assertThat(testCategory.getCoverImageSmall()).isEqualTo(UPDATED_COVER_IMAGE_SMALL);
        assertThat(testCategory.getMemo()).isEqualTo(UPDATED_MEMO);
        assertThat(testCategory.getRecordStatus()).isEqualTo(UPDATED_RECORD_STATUS);
    }
